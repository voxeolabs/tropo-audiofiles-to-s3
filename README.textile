...
To run locally, copy the sample configuration file for Amazon S3:

<pre><code>cp ~/application-directory/config/amazon_s3.yml.sample ~/application-directory/config/amazon_s3.yml</code></pre>

Then configure this file with your Amazon S3 credentials and S3 Bucket. Install the aws-s3 gem:

<pre><code>sudo gem install aws-s3</pre></code>
